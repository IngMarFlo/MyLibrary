...
public class CameraBasicFragment extends Fragment implements
    ...
    private Button      btnCancel, btnAccept, imvTakePhoto;
    ...
    static CameraBasicFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {
            mFile = (File) getArguments().getSerializable(CameraActivity.DESTINY);
        }
    ...
    public void onViewCreated(@NonNull final View view, Bundle savedInstanceState) {
        imvTakePhoto=  view.findViewById(R.id.picture);
        btnAccept   =  view.findViewById(R.id.btnCameraBasic_aceptar);
        btnCancel   =  view.findViewById(R.id.btnCameraBasic_cancelar);
    ...
    private void setVisibilityButtons(final boolean visible){
        final Activity activity = getActivity();
        if (activity != null) {
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    btnAccept   .setVisibility((visible) ? View.VISIBLE : View.GONE);
                    btnCancel   .setVisibility((visible) ? View.VISIBLE : View.GONE);
                    imvTakePhoto.setVisibility((!visible) ? View.VISIBLE : View.GONE);
                }
            });
        }
    }
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.btnCameraBasic_aceptar) {
            Intent i = new Intent();
            i.putExtra(CameraActivity.RESULT, mFile);
            if (getActivity() != null) {
                getActivity().setResult(Activity.RESULT_OK, i);
                getActivity().finish();
            }

        } else if (id == R.id.btnCameraBasic_cancelar) {
            unlockFocus();
